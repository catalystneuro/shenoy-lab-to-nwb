...
sess_names = ['P20180327', 'P20180607', 'P20180608', 'P20180609', 'P20180612', 'P20180613',
              'P20180614',
              'P20180615',
              'P20180620',
              'P20180622',
...
for name in sess_names:
    mat_pt = Path(fr'/mnt/scrap/catalyst_neuro/sakshamsharda/shenoy/PrimateNeuropixel/{name}/{name}.behavior.mat')
    bin_pt = Path(
...
def converter(mat_pt, bin_pt):
    ...
    print(f'**************************conversion run for {mat_pt.name.split(".")[0]}............................')


Parallel(n_jobs=20)(delayed(converter)(mat_pt,bin_pt) for mat_pt,bin_pt in zip(mat_pt_list, bin_pt_list))