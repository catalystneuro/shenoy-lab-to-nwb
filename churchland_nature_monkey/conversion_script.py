...
source_folder = Path(
    r"C:\Users\Saksham\Documents\NWB\shenoy\data\Jenkins\SpikeSorted\0928"
)
...
nwbfile_saveloc = source_folder / f"{source_folder.name}_nwb_v2_luiz.nwb"
conversion_options = dict(
    A1=dict(es_key=f"ElectricalSeries{Path(nsx_list[0]).stem[-4:]}"),
